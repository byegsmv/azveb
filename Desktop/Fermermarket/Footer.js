// =================================================================
// FERMERMARKET.AZ - FOOTER COMPONENT (Dinamik Sosial Media Linkləri)
// =================================================================
"use client";
...
export default function Footer() {
  ...
  // Dinamik Mətn İdarəsindən gələn sosial media linkləri
  ...
  const telegramUrl = st("footer.telegramUrl", "https://t.me/fermermarket");
  const youtubeUrl = st("footer.youtubeUrl", "https://youtube.com");
          ...
          <div>
            ...
            <div className="mt-5">
              <p className="mb-3 text-xs font-bold uppercase tracking-widest text-gray-400">
                {st("footer.followUs", "Bizi izləyin")}
              </p>
              <div className="flex flex-wrap gap-2">
                {SOCIAL_LINKS.map((s) => (
                  <a
                    ...
                    onClick={!s.href || s.href === "#" ? (e) => e.preventDefault() : undefined}
                  >
